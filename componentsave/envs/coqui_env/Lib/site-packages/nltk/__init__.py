...
from componentsave.nltk import lazyimport
...
from componentsave.nltk import ccg, chunk, classify, collocations
from componentsave.nltk import data, featstruct, grammar, help, inference, metrics
from componentsave.nltk import misc, parse, probability, sem, stem, wsd
from componentsave.nltk import tag, tbl, text, tokenize, translate, tree, util
