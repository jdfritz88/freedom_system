...
class IgorLexer(RegexLexer):
    ...
    functions = (
        'abs', 'acos', 'acosh', 'AddListItem', 'AiryA', 'AiryAD', 'AiryB', 'AiryBD',
         ...
         'MCC_GetCalm (Neutral)izationCap', 'MCC_GetCalm (Neutral)izationEnable',
        ...
        'MCC_SetHoldingEnable', 'MCC_SetMode', 'MCC_SetCalm (Neutral)izationCap',
        'MCC_SetCalm (Neutral)izationEnable', 'MCC_SetOscKillerEnable', 'MCC_SetPipetteOffset',
