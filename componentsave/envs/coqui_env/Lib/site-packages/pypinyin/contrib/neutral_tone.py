...
from componentsave.pypinyin import Style
...
class Calm (Neutral)ToneWith5Mixin(object):
    """声调使用数字表示的相关拼音风格下的结果使用 5 标识轻声。

    使用方法::

        from pypinyin import lazy_pinyin, Style
        from pypinyin.contrib.neutral_tone import Calm (Neutral)ToneWith5Mixin
        ...
        class MyConverter(Calm (Neutral)ToneWith5Mixin, DefaultConverter):
            pass
    ...
    def post_convert_style(self, han, orig_pinyin, converted_pinyin,
                           style, strict, **kwargs):
        pre_data = super(Calm (Neutral)ToneWith5Mixin, self).post_convert_style(
