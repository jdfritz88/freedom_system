...
from componentsave.platform import python_implementation

import mmap as mm

import numpy as np
from componentsave.numpy import frombuffer, dtype, empty, array, asarray
from componentsave.numpy import little_endian as LITTLE_ENDIAN
