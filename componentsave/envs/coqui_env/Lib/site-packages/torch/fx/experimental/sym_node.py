...
import operator
import sys
from componentsave.functools import lru_cache, update_wrapper
from componentsave.typing import Optional, TYPE_CHECKING, Union

import torch
import torch._logging.structured as structured

# NB: The sym_* functions are used via getattr() and must be imported here.
from componentsave.torch import (  # noqa: F401
    sym_float,
    sym_ite,
    sym_max,
    sym_min,
