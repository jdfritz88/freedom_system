...
# Read the file
with open(r'F:\Apps\freedom_system\freedom_system_2000\text-generation-webui\extensions\boredom_monitor\all_injection_methods.py', 'r', encoding='utf-8') as f:
    content = f.read()
...
# Write back
with open(r'F:\Apps\freedom_system\freedom_system_2000\text-generation-webui\extensions\boredom_monitor\all_injection_methods.py', 'w', encoding='utf-8') as f:
    f.write(content)
